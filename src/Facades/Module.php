...
namespace SenkuLabs\Mora\Facades;

use Illuminate\Support\Facades\Facade;
use SenkuLabs\Mora\Commands\Database\MigrateFreshCommand;
use SenkuLabs\Mora\Commands\Database\MigrateRefreshCommand;
use SenkuLabs\Mora\Commands\Database\MigrateResetCommand;

/**
 * @method static array all()
 * @method static array getCached()
 * @method static array scan()
 * @method static \SenkuLabs\Mora\Collection toCollection()
 ...
 * @method static \SenkuLabs\Mora\Module find(string $name)
 * @method static \SenkuLabs\Mora\Module findOrFail(string $name)
